        ...
        var CLODOP = {
                ...
                "list": [{
                ...
                },
                    {
                        ...
                        "pagelist": [{
                            ...
                            "name": "Screen 640x480 (VGA)"
                        }, {
                            "name": "Screen 800x600 (SVGA)"
                        }, {
                            "name": "Screen 1024x768 (XGA)"
                        }, {
                            "name": "Screen 1280x1024 (SXGA)"
                        }, {
                            "name": "TV NTSC DV 720x480"
                        }, {
                            "name": "TV NTSC D1 720x486"
                        }, {
                            "name": "TV NTSC D1 Square Pix 720x540"
                        }, {
                            "name": "TV PAL Square Pix 768x576"
                        }, {
                            "name": "TV PAL 720x576"
                        }, {
                            "name": "TV HDTV 1280x720"
                        }, {
                            "name": "TV HDTV 1920x1080"
                        }, {
                            "name": "21*14"
                        }, {
                            "name": "高14"
                    ...
                    },
                    {
                        ...
                        "name": "FX DocuPrint M225 dw Printer",
                        "DriverName": "FX DocuPrint M225 dw",
                        "PortName": "WSD-76b27476-b9e8-4af1-9b0d-49dbacc841ac.0060",
                        "Orientation": "1",
                        "PaperSize": "9",
                        "PaperLength": "2970",
                        "PaperWidth": "2100",
                        ...
                        "name": "EPSON LQ-635K ESC/P 2 Ver 2.0",
                        "DriverName": "EPSON LQ-635K ESC/P 2 Ver 2.0",
                        "PortName": "USB003",
                        "Orientation": "1",
                        "PaperSize": "273",
                        "PaperLength": "2970",
                        ...
                        "name": "\\\\192.168.180.62\\FX DocuPrint M225 dw",
                        "DriverName": "FX DocuPrint M225 dw",
                        "PortName": "BRN30055CAFC116",
                        "Orientation": "1",
                        "PaperSize": "9",
                        "PaperLength": "2970",
                        "PaperWidth": "2100",
                        ...
                        "name": "\\\\USER-20171102OT\\EPSON LQ-635K ESC/P 2 Ver 2.0",
                        "DriverName": "EPSON LQ-635K ESC/P 2 Ver 2.0",
                        "PortName": "USB002",
                        "Orientation": "1",
                        "PaperSize": "230",
                        ...
                        "name": "\\\\USER-20171102OT\\FX DocuPrint M225 dw",
                        "DriverName": "FX DocuPrint M225 dw",
                        "PortName": "BRN30055CAFC116",
                        "Orientation": "1",
                        "PaperSize": "9",
                            ...
                            try {
                                ...
                                if (CLODOP.On_Return) {
                                    ...
                                    if (strResult == "true" || strResult == "false")
                                        CLODOP.On_Return(strFTaskID, strResult == "true");
                                    else
                    ...
                    if (oType.replace(/^\s+|\s+$/g, "").toLowerCase().indexOf("time:") == 0) {
                        ...
                        if (oType.toLowerCase() == "isvalidformat")
                            ...
                            if (oType.toLowerCase() == "weekindex")
                                ...
                                if (/(y+)/i.test(oValue))
                                    oValue = oValue.replace(RegExp.$1, (iYear + "").substr(4 - RegExp.$1.length));
                                if (/(m+:)/i.test(oValue))
                                    oValue = oValue.replace(RegExp.$1, ("00" + iMinutes + ":").substr(("00" + iMinutes + ":").length - RegExp.$1.length));
                                if (/(M+)/i.test(oValue)) {
                        ...
                        alert(this.altMessageNoReadWriteFile)
                }
                this.DoInit();
            ...
            PRINT_DESIGN: function() {
                ...
                if (this.blIslocal) {
                    ...
                    alert(this.altMessageNoPrintDesign);
                this.DoInit();
                this.blWorking = false;
                return tResult;
            },
            PRINT_SETUP: function() {
                ...
                if (this.blIslocal) {
                    ...
                    alert(this.altMessageNoPrintSetup);
                this.DoInit();
                this.blWorking = false;
                return tResult;
            },
            ...
            SAVE_TO_FILE: function(strFileName) {
                ...
                if (this.blIslocal) {
                    ...
                    alert(this.altMessageNoWriteFile);
                this.DoInit();
                this.blWorking = false;
                return tResult;
            },
            ...
            GET_FILE_TEXT: function(strFileName) {
                ...
                if (this.blIslocal) {
                    ...
                    alert(this.altMessageNoReadFile);
                this.DoInit();
                this.blWorking = false;
                return tResult;
            },
            ...
            Get_AOBridge_SubPrinters_List: function(BridgeNameOrIndex, strListName, strSplit, DriverNameOrIndex) {
                if (!DriverNameOrIndex)
                    DriverNameOrIndex = "(AO)Client-Bridge Driver";
                if (!strSplit)
                    strSplit = "\n";
                if (!strListName)
                    strListName = "name";
            ...
            Get_AOBridge_SubPrinters_PageSize_List: function(BridgeNameOrIndex, SubPrinterNameOrIndex, strSplit, DriverNameOrIndex) {
                if (!DriverNameOrIndex)
                    DriverNameOrIndex = "(AO)Client-Bridge Driver";
                if (!strSplit)
                    strSplit = "\n";
