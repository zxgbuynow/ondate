    ...
    export default {
        ...
        created () {
            ...
            post(host + "/collage/Api/goods_detail", {
                ...
                var nickname = data.nickname?data.nickname:this.userdata.nickName;
                console.log("wzh",share_url)
                var shareData = {
                    title: this.eventinfo.title, // 分享标题
                    desc:  '请您帮砍价', // 分享描述
                    link: share_url, //分享的链接地址
                    imgUrl: this.goods.cover, // 分享图标
        ...
        //             path: 'pages/collage/group_detail/main?inviteuid=' + that.mid + '&id=' + this.groupid,
        ...
        //             title: this.goods.title,
        //             desc: that.userdata.nickName + '邀请您参加拼团', // 分享描述
        //             path: 'pages/collage/collage_detail/main?inviteuid=' + that.mid + '&id=' + this.goods.id,
        //             imageUrl: this.goods.cover,
        //             success: function(res) {
