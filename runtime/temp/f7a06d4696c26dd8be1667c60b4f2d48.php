<?php /*a:2:{s:51:"/data/httpd/wx/application/admin/view/menu/add.html";i:1553940778;s:55:"/data/httpd/wx/application/admin/view/publics/base.html";i:1553940778;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
...
<script type="text/javascript" src="/public/static/uploadify/jquery.uploadify.min.js"></script>
    <div class="main-title cf">
        <h2>新增<?php echo htmlentities($nav_title); ?>菜单</h2>
    </div>
    <!-- 标签页导航 -->
<div class="tab-wrap">
    ...
    <form id="form" action="<?php echo htmlentities($post_url); ?>" method="post" class="form-horizontal">
            ...
            <div class="form-item cf toggle-<?php echo htmlentities($field['name']); ?>">
              <label class="item-label">
                ...
                <?php echo htmlentities($field['title']); ?> <span class="check-tips">
                <?php if(!(empty($field['remark']) || (($field['remark'] instanceof \think\Collection || $field['remark'] instanceof \think\Paginator ) && $field['remark']->isEmpty()))): ?>（<?php echo $field['remark']; ?>）<?php endif; ?>
                    ...
                    <input type="number" class="text input-large" name="<?php echo htmlentities($field['name']); ?>" value="<?php echo I($field['name'], $field['value']); ?>">
                  <?php break; case "string": ?>
                    ...
                    <input type="datetime" autocomplete="off" name="<?php echo htmlentities($field['name']); ?>" class="text input-large time" value="<?php echo I($field['name'], $field['value']); ?>" placeholder="请选择时间" />
                  <?php break; case "date": ?>
                    <input type="datetime" autocomplete="off" name="<?php echo htmlentities($field['name']); ?>" class="text input-large date" value="<?php echo I($field['name'], $field['value']); ?>" placeholder="请选择日期" />
                  <?php break; case "bool": ?>
                  ...
                  <?php break; case "mult_picture": ?>
                    <div class="controls uploadrow2" data-max="9" title="点击上传图片" rel="<?php echo htmlentities($field['name']); ?>">
                      <input type="file" id="upload_picture_<?php echo htmlentities($field['name']); ?>">
                    </div>
                    <div class="upload-img-view" id='mutl_picture_<?php echo htmlentities($field['name']); ?>'>
                      <?php if(!(empty($data[$field['name']]) || (($data[$field['name']] instanceof \think\Collection || $data[$field['name']] instanceof \think\Paginator ) && $data[$field['name']]->isEmpty()))): ?>
                        <div class="upload-pre-item22">
                        <img width="100" height="100" src="<?php echo htmlentities(get_cover_url($data[$field['name']])); ?>"/>
                        <input type="hidden" name="<?php echo htmlentities($field['name']); ?>[]" value="<?php echo htmlentities($data[$field['name']]); ?>"/></div>
                      <?php endif; ?>
                    </div>
                  <?php break; case "file": ?>
