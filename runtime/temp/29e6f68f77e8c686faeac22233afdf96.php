      ...
      <div class="tab-content"> 
        ...
        <form id="form" action="<?php echo $post_url; ?>" method="post" class="form-horizontal">
              ...
              <?php if(is_array($fields) || $fields instanceof \think\Collection || $fields instanceof \think\Paginator): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i;if($field['is_show'] == 4): ?>
                  <input type="hidden" class="text" name="<?php echo htmlentities($field['name']); ?>" value="<?php echo htmlentities((isset($data[$field['name']]) && ($data[$field['name']] !== '')?$data[$field['name']]:'')); ?>">
                  ...
                  <div class="form-group row cf toggle-<?php echo htmlentities($field['name']); ?>">
                    ...
                    <div class="col-sm-8">
                      <?php switch($field['type']): case "num": ?>
                          <input type="number" class="text" name="<?php echo htmlentities($field['name']); ?>" value="<?php echo htmlentities((isset($data[$field['name']]) && ($data[$field['name']] !== '')?$data[$field['name']]:'')); ?>">
              ...
              <div id="map" style="height:400px;width:600px;border:1px solid #bcbcbc;"></div>';
                        ...
                        <?php echo W('common/cascade/cascade', array('name'=>$field['name'],'value'=>$data[$field['name']],'extra'=>$field['extra'])); break; case "radio": $_result=parse_field_attr($field['extra']);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          ...
                          <label class="textarea">
                            <textarea name="<?php echo htmlentities($field['name']); ?>" style="width:800px; height:100px;"><?php echo htmlentities((isset($data[$field['name']]) && ($data[$field['name']] !== '')?$data[$field['name']]:'')); ?></textarea>
                        ...
                        <?php break; default: ?>
                        <input type="text" class="text" name="<?php echo htmlentities($field['name']); ?>" value="<?php echo htmlentities((isset($data[$field['name']]) && ($data[$field['name']] !== '')?$data[$field['name']]:'')); ?>">
                      <?php endswitch; ?>
