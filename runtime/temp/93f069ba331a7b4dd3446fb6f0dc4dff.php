...
<?php if(config('PUBLIC_TYPE')!=2) {  ?>
  <section class="tab-content" id="contents"> 
    ...
    <div style="overflow:hidden; zoom:1;">
      <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:30px" src="/public/weixin/images/weixin.png"/> 我的公众号</h3>
    ...
    <div class="data-table" style="margin:0;"> <?php if(!(empty($list_data[0]) || (($list_data[0] instanceof \think\Collection || $list_data[0] instanceof \think\Paginator ) && $list_data[0]->isEmpty()))): ?>
      ...
      <?php else: ?>
      <div style="padding:100px; text-align:center;"><img style="vertical-align:middle;" src="/public/weixin/images/weixin.png"/> 你还没有创建公众号</div>
      <?php endif; ?> </div>
  </section>
  ...
  <section class="tab-content" id="contents"> 
    <!-- 数据列表 -->
    <div style="overflow:hidden; zoom:1;">
      <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:30px" src="/public/weixin/images/weixin.png"/> 我的小程序</h3>
    ...
    <div class="data-table" style="margin:0;"> <?php if(!(empty($list_data[1]) || (($list_data[1] instanceof \think\Collection || $list_data[1] instanceof \think\Paginator ) && $list_data[1]->isEmpty()))): ?>
      ...
      <?php else: ?>
      <div style="padding:100px; text-align:center;"><img style="vertical-align:middle;" src="/public/weixin/images/weixin.png"/> 你还没有创建小程序</div>
      <?php endif; ?> </div>
  </section>
  <?php  }  ?>
</div>
