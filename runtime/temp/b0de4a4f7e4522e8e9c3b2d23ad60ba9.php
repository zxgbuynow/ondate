<?php /*a:1:{s:60:"/data/httpd/ondate/application/admin/view/publics/login.html";i:1562590036;}*/ ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>欢迎您登录WeiPHP管理平台</title>
        <link rel="stylesheet" type="text/css" href="/admin/css/login.css?v=<?php echo SITE_VERSION; ?>" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login'); ?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>WeiPHP管理后台</h3>
