...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="wrap">
      ...
      <!-- /头部 -->
       <?php $menu_default = session('menu_default'); ?>
<style>
    .goods_dialog {
        ...
        <section id="contents">
            <div class="tab-content">
                ...
                <div style="margin:200px 200px">
                    <h4>
                        <center><img src="/public/static/base/images/error.png" /></center>
                        <center><br/><br/>你还没有创建店铺，请先<a href="<?php echo U('add'); ?>">创建店铺</a>！</center>
                    </h4>
                </div>
                <?php else: if(!empty($normal_tips)): ?>
                <p class="normal_tips" style="border-bottom: 0"><b class="fa fa-info-circle"></b> <?php echo $normal_tips; ?></p>
                <br/> <?php endif; ?>
                <div class="m-home-head">
                    <ul>
                        <li>
                            <a class="btn btn-primary" href="<?php echo U ( 'Shop/Shop/preview',array('uid'=>get_mid())); ?>" target="_blank">预览店铺</a>
                        </li>
                        <li>
                            <a class="btn btn-link" id="copyLink" href="javascript:;" data-clipboard-text="<?php echo WAP_URL; ?>?pbid=<?php echo get_pbid(); ?>&uid=<?php echo get_mid(); ?>">复制链接</a>
                        </li>
                    </ul>
                ...
                <div class="chart-info">
                    <div class="all-vip">
                        <div class="info">
                            <p class="count"><?php echo htmlentities($follow_count['total']); ?></p>
                            <p>粉丝总数量</p>
                        </div>
                    ...
                    <div class="today-vip">
                        <div class="info">
                            <p class="count"><?php echo htmlentities($follow_count['un_count']); ?></p>
                            <p>取消关注粉丝总数量</p>
                        </div>
...
<script>
    $(function() {
        $('.shop_pv').highcharts({
            ...
            series: [{
                name: '<?php echo htmlentities($series); ?>',
                data: [{
                    $highcharts.series
                }]
            }]
